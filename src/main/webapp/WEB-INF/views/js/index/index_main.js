require(['layer1', 'common/util', 'jquery', 'common/validateRules', 'metisMenu', 'jquery.layout','jquery.nanoscroller'], function (layer, util) {
    ...
    function bind() {
        util.bindEvents([{
            ...
            handler:function () {
                ...
                $('.J_mainContent').find('iframe').attr('src', address);
                return false;
            }
        }])
    }
